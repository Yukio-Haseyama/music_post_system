...
public interface JpaConst {
    ...
    String SONGS_COL_SONGS_DATE = "song_date";//いつの楽曲かを示す日付
    ...
    //会員番号とハッシュ化済パスワードを条件に会員を取得する
    String Q_MEM_GET_BY_CODE_AND_PASS = ENTITY_MEM + "getByCodeAndPass";
    String Q_MEM_GET_BY_CODE_AND_PASS_DEF = "SELECT m FROM Member AS m WHERE m.code = :" + JPQL_PARM_CODE + " AND m.password = :" + JPQL_PARM_PASSWORD;
    ...
    //指定した会員が作成した日報の件数を取得する
    String Q_SONG_COUNT_ALL_MINE = ENTITY_SONG + ".countAllMine";
    String Q_SONG_COUNT_ALL_MINE_DEF = "SELECT COUNT(s) FROM Song AS s WHERE s.member = :" + JPQL_PARM_MEMBER;
